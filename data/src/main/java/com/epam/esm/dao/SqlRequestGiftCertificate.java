...
public final class SqlRequestGiftCertificate {
    ...
    public static final String SELECT_FIND_BY_NAME = "select id, name, description, price, creation_date, last_update_date, duration from gift_certificates  where name like ?";
    public static final String SELECT_FIND_BY_DESCRIPTION = "select id, name, description, price, creation_date, last_update_date, duration from gift_certificates  where description like ?";
